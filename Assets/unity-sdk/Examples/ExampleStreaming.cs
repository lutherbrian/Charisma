        ...
        private void OnRecognize(SpeechRecognitionEvent result)
        {
            if (result != null && result.results.Length > 0)
            {
                foreach (var res in result.results)
                {
                    ...
                    {
                        string text = string.Format("{0} {1}", alt.transcript, res.final ? "" : "", alt.confidence);
                    ...
                    if (res.keywords_result != null && res.keywords_result.keyword != null)
                    {
                        ...
                        {
                            Log.Debug("ExampleStreaming.OnRecognize()", "keyword: {0}", keyword.normalized_text, keyword.confidence, keyword.start_time, keyword.end_time);
                        }
                    }
